...
Para el envenenamiento ARP es importante obtener las direcciones MAC de la red objetivo, se puede usar `wireshark` para ello.
Luego, para el spoofing ARP, se puede usar la herramienta `arpspoof` ejecutando:
